...
public class User {
    ...
    // public users.ShippingAddress getShippingAddressById(int shippingAddressId) {
    //     ArrayList<users.ShippingAddress> shippingAddressesList = (ArrayList<users.ShippingAddress>) shippingAddresses.stream().filter((s) -> s.getShippingAddressId() == shippingAddressId).collect(Collectors.toList());
